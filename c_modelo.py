...
def recomendacion(libro = list(movies['title'])):
     
    ind_libro=movies[movies['title']==libro].index.values.astype(int)[0]   #### obtener indice de libro seleccionado de lista
    similar_m = movies_dum.corrwith(movies_dum.iloc[ind_libro,:],axis=1) ## correlación entre libro seleccionado y todos los otros
